...
<x-layout_hr>
    ...
    <div class="bg-gray-100">
        ...
        <form class="p-4" id="add_member_form" action="{{ route('editpasswordHr',$hr->id) }}"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input  name="current_pwd" value="current_pwd" type="password"   id="last-name"
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="last-name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        New Password</label>
                    <input  type="password" name="new_pwd" value="{{ old('new_pwd') }}" id="last-name"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input  type="password" name="confirm_pwd"  value="{{ old('confirm_pwd') }}"   id="last-name"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="new password" required="">
                        @error('confirm_pwd')
                        <code>{{ $message }}</code>
