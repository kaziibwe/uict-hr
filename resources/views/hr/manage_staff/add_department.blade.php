<x-layout_hr>
    <div class="mt-10 mb-20 relative overflow-x-auto custom-scrollbar shadow-md sm:rounded-lg z-0">
        ...
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="department" role="tabpanel"
            ...
            <form action="{{ route('createDepartment') }}" method="post" enctype="multipart/form-data" >
                @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="department_name"
                            ...
                            Name</label>
                        <input type="text" id="department_name" name="name"  value="{{ old('name') }}"
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" value="{{ old('description') }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="A Brief sentence on what the department does..." rows="3">{{ old('description') }}</textarea>
                            @error('name')
                            <code class="text-red-800">{{ $message }}</code>
                            @enderror
