                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Current Appointment</th>
                                <th scope="col" class="px-6 py-3">Date Of Appointment</th>
                                <th scope="col" class="px-6 py-3">NIN</th>
                                <th scope="col" class="px-6 py-3">TIN</th>
                                <th scope="col" class="px-6 py-3">Staff Number</th>
                            ...
                            @unless ($items->isEmpty())
                                @foreach ($items as $item)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            {{-- {{ $item->department_id }} --}} {{ $sn++ }}
                                        </td>
                                        <th scope="row" id="tableRows"
                                            class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                            <a href="{{ route('view_staff_profile', $item->id) }}">
                                                <img class="w-10 h-10 rounded-full"
                                                    src="{{ $item->image ? asset('storage/' . $item->image) : asset('/avatar.png') }}"
                                                    alt="Jese image">
                                                <div class="ps-3">
                                        ...
                                        @if ($item->department_id)
                                            @php
                                                $department = \App\Models\Department::find($item->department_id); // Assuming Member is your model
                                            @endphp
                                        ...
                                        @else
                                            <code>
                                                <a href="{{ route('edit_staff', ['id' => $item->id]) }}" class=" text-green-800">Assign
                                                    Department</a>
                                            </code>
                                        @endif
                                    </td>
