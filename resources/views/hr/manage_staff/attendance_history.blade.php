                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg staff_member_table ">
                    <div
                        ...
                        <div class="relative mr-4">
                            ...
                            <form action="{{ route('attendance_history') }} " method="GET" style="display: flex; align-items: center; gap: 10px;">
                            <input type="date" name='date'
                                class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                />
                             <input type="submit" value="search" class="bg-blue-500 py-1 px-2 rounded text-white text-sm">
                            </form>
                                                    {{-- <input type="text"> --}}
                        ...
                        @unless ($attendances->isEmpty())
                            ...
                            <tr
                                ...
                                <th scope="row" id="tableRows"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{ $attendance->image ? asset('storage/' . $attendance->image) : asset('/avatar.png') }}"
                                        alt="Jese image">
