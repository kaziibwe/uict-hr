<x-layout_hr>
    <div class="mt-10 mb-20 relative overflow-x-auto custom-scrollbar shadow-md sm:rounded-lg z-0">
        ...
        <div class="rounded-lg bg-gray-50 dark:bg-gray-800" id="add_member" role="tabpanel"
            ...
            <form class="p-4" id="add_member_form" action="{{ route('updateUser', $staff->id) }}"
                enctype="multipart/form-data" method="POST">
                @method('PUT')


                @csrf
                <img src="{{ $staff->image ? asset('storage/' . $staff->image) : asset('/avatar.png') }}"
                    alt="">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="file" name="image" value="{{ $staff->image }}" accept="image/*"
                    ...
                    <div>
                        <label for="fullname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Full
                            name</label>
                        <input type="text" name="name" value="{{ $staff->name }}" id="fullname"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Fullname" />
                        @error('name')
                            <code class="text-red-800">{{ $message }}</code>
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" value="{{ $staff->title }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="date" id="dob" name="dob" value="{{ $staff->dob }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="current_appointment" name="current_appointment"
                            value="{{ $staff->current_appointment }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="nin" name="nin" value="{{ $staff->nin }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="NIN" />
                        @error('nin')
                            <code class="text-red-800">{{ $message }}</code>
                    ...
                    <div>
                        ...
                        <input type="text" id="tin" name="tin" value="{{ $staff->tin }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="TIN" />
                        @error('tin')
                            <code class="text-red-800">{{ $message }}</code>
                    ...
                    <div>
                        ...
                        <input type="text" id="contact" name="phone" value="{{ $staff->phone }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="number" id="allowances" name="allowances" value="{{ $staff->allowances }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        <label for="gross_pay"
                            ...
                            Pay</label>
                        <input type="text" id="gross_pay" name="gross_pay" value="{{ $staff->gross_pay }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="education" name="education" value="{{ $staff->education }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div>
                        <label for="netpay" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Net
                            Pay</label>
                        <input type="text" id="netpay" name="netpay" value="{{ $staff->netpay }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Net Pay" />
                        @error('netpay')
                            <code class="text-red-800">{{ $message }}</code>
                    ...
                    <div>
                        ...
                        <input type="text" id="duty" name="duty" value="{{ $staff->duty }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Duty" />
                        @error('duty')
                            <code class="text-red-800">{{ $message }}</code>
                            ...
                            @unless ($departments->isEmpty())
                                @foreach ($departments as $department)
                                    <option value="{{ $department->id }}"
                                        @if ($department->id == $selectedDepartmentId) selected @endif>{{ $department->name }}</option>
                                @endforeach
                            @else
