<x-layout_hr>
    ...
    <div class="bg-gray-100">
        ...
        <form class="p-4" id="add_member_form" action="{{ route('updateSensor') }}"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="sensor"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">BSSID</label>
                    <input type="text" id="sensor" name="sensor" value=""
